...
public class EditingTools.CropTool : EditingTool {
    ...
    private static ConstraintDescription[] create_constraints () {
        ...
        result += new ConstraintDescription (_ ("Facebook Cover Photo"), 820, 360, true);
        result += new ConstraintDescription (_ ("Facebook Timeline Photo"), 2, 3, true);
        result += new ConstraintDescription (_ ("-"), 0, 0, false, SEPARATOR);
        ...
        result += new ConstraintDescription (_ ("A5 (148 x 210 mm)"), 148, 210, true);
