...
namespace Granite.Widgets {
    ...
    public class PhotosRating : Gtk.EventBox {
        ...
        public class Renderer : Object {
            ...
            public virtual signal void render () {
                ...
                if (starred_pix == null || not_starred_pix == null) {
                    var starred =  Resources.Icons.STARRED;
                    var not_starred = Resources.Icons.NOT_STARRED;
        ...
        public PhotosRating (bool centered, Gtk.IconSize size, bool symbolic = false) {
    ...
    public class RatingMenuItem : Gtk.MenuItem {
        ...
        public PhotosRating rating { get; private set; }
        ...
        public RatingMenuItem () {
            rating = new PhotosRating (false, Gtk.IconSize.MENU, false);
            add (rating);
