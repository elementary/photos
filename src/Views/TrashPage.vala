...
public class TrashPage : CheckerboardPage {
    ...
    public override Gtk.ActionBar get_toolbar () {
        if (toolbar == null) {
            ...
            toolbar.pack_end (empty_trash_button);
            toolbar.pack_end (delete_button);
            toolbar.pack_end (restore_button);
